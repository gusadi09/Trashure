...
open class ChartViewBulan: MacawView {
    ...
    private let barsValues = [75, 100, 50, 150, 0, 0]
    private let barsCaptions = ["Jan", "Feb", "Mar", "Apr", "Mei", "Jun"]
    private let barsCount = 6
    private let barsSpacing = 35
